...
class LibraryRepository:
    ...
    @staticmethod
    def get_library_item(user_id: int, game_id: int) -> Optional[UserLibrary]:
    ...
    @staticmethod
    def add_to_library(user_id: int, game_id: int) -> UserLibrary:
        existing_item = LibraryRepository.get_library_item(user_id, game_id)
        if existing_item:
    ...
    def remove_from_library(user_id: int, game_id: int) -> bool:
        library_item = LibraryRepository.get_library_item(user_id, game_id)
